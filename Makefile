...
ACLOCAL = ${SHELL} /usr/libusb-1.0.9/missing --run aclocal-1.11
AMTAR = ${SHELL} /usr/libusb-1.0.9/missing --run tar
...
AR = ar
AUTOCONF = ${SHELL} /usr/libusb-1.0.9/missing --run autoconf
AUTOHEADER = ${SHELL} /usr/libusb-1.0.9/missing --run autoheader
AUTOMAKE = ${SHELL} /usr/libusb-1.0.9/missing --run automake-1.11
AWK = gawk
CC = gcc
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /usr/libusb-1.0.9/missing --run makeinfo
...
abs_builddir = /usr/libusb-1.0.9
abs_srcdir = /usr/libusb-1.0.9
abs_top_builddir = /usr/libusb-1.0.9
abs_top_srcdir = /usr/libusb-1.0.9
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /usr/libusb-1.0.9/install-sh
